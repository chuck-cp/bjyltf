    ...
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                <td>
                    <p>所属团队</p>
                    <?php  echo $form->field($searchModel, 'team_name')->dropDownList(SignTeam::signTeam(2),['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>团队成员数</p>
                ...
                <td>
                    <p>签到总数</p>
                    <?php  echo $form->field($searchModel, 'total_sign_number')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>未签到数</p>
                ...
                <!--<td>
                    <p>差评率</p>
                    <?php /* echo $form->field($searchModel, 'bad_evaluate_rate')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) */?>
                </td>-->
            ...
            <tr>
                ...
                <td>
                    <p>好评数</p>
                    <?php  echo $form->field($searchModel, 'good_evaluate_number')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>中评数</p>
                    <?php  echo $form->field($searchModel, 'middle_evaluate_number')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>差评数</p>
                    <?php  echo $form->field($searchModel, 'bad_evaluate_number')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>开始时间</p>
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($searchModel){
                    return $searchModel->maintainTeam['team_name'];
                }
            ],
            [
                'label' => '团队成员数',
                'value' => function($searchModel){
                    return $searchModel->maintainTeam['team_member_number'];
                }
            ],
            [
                'label' => '签到总数',
                'value' => function($model){
                    return $model->total_sign_number_sum;
                }
            ],
            [
                'label' => '未签到成员数',
            ...
            [
                'label' => '好评数',
                'value' => function($model){
                    return $model->good_evaluate_number_sum;
                }
            ],
            [
                'label' => '中评数',
                'value' => function($model){
                    return $model->middle_evaluate_number_sum;
                }
            ],
            [
                'label' => '差评数',
                'value' => function($model){
                    return $model->bad_evaluate_number_sum;
                }
            ],
            [
                'label' => '差评率',
                'value' => function($model){
                    if($model->bad_evaluate_number_sum==0||$model->total_evaluate_number_sum==0){
                        return '0%';
                    }
                    $repeat_sign_rate = round($model->bad_evaluate_number_sum/$model->total_evaluate_number_sum,'4')*100;
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url,$searchModel) use ($create_at,$create_at_end){
                        return Html::a('查看详情',['/sign/sign/maintain-team-view','create_at'=>$create_at,'create_at_end'=>$create_at_end,'team_id'=>$searchModel->team_id]);
                    },
                ],
            ],
        ],
