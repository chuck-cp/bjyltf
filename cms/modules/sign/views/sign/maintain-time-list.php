    ...
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                <td>
                    <p>拜访店铺</p>
                    <?=$form->field($searchModel,'shop_name')->textInput(['placeholder'=>'店铺名称','class'=>'form-control fm'])->label(false);?>
                </td>
                <td>
                    <p>用户名</p>
                ...
                <td>
                    <p>是否为首次签到</p>
                    <?php  echo $form->field($searchModel, 'first_sign')->dropDownList(['1'=>'是','2'=>'否'],['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>所属团队</p>
                ...
                <td>
                    <p>签到地址</p>
                    <?=$form->field($searchModel,'shop_address')->textInput(['class'=>'form-control fm'])->label(false);?>
                </td>
                <!--<td>
                    <p>有无屏幕</p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '店铺类型',
                'value' => function($searchModel){
                    return Shop::getTypeByNum($searchModel->signMaintain['shop_type']);
                }
            ],
            [
                'label' => '用户名',
