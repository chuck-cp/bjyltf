    ...
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                ...
                <td>
                    <p>所属团队</p>
                    <?php  echo $form->field($searchModel, 'team_name')->dropDownList(SignTeam::signTeam(1,$sign_team),['prompt'=>'全部','key'=>'province','class'=>'form-control fm'])->label(false) ?>
                </td>
                <td>
                    <p>有无屏幕</p>
            ...
            <tr>
                ...
                <td colspan="4">
                    ...
                    <?if(LoginForm::checkPermission('/export/power/sign_business_export')):?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'label' => '有无屏幕',
                'value' => function($searchModel){
                    return $searchModel->signBusiness['screen_number']==0?'无':'有';
                }
            ],
            [
                ...
                'buttons' => [
                    'view' => function($url,$searchModel){
                        return Html::a('查看详情',['/sign/sign/sign-business-view','id'=>$searchModel->id]);
                    },
                ],
            ],
        ],
