...
<div class="sign-team-index">
    ...
    $form = ActiveForm::begin([
        'action' => ['business-time-unqualified'],
        'method' => 'get',
    ]);
    ?>
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                ...
                <td>
                    <p>已签到次数</p>
                    <div class="col-xs-2 form-group">
                        <?=$form->field($searchModel,'number')->dropDownList(['1'=>'由高到低','2'=>'由低到高'],['prompt'=>'全部','class'=>'form-control fm'])->label(false);?>
                </td>
                <td>
                    <p>签到时间</p>
