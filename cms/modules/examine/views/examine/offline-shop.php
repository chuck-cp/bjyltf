...
//        'action' => ['index'],
    ...
    <div class="row">
        ...
        <div class="col-xs-2 form-group">
            <?=$form->field($searchModel,'status')->dropDownList(['0'=>'待审核','1'=>'审核未通过','2'=>'待安装'],['class'=>'form-control fm','prompt'=>'全部'])->label('申请状态');?>
        </div>
        <div class="col-xs-2 form-group">
...
<script>
    ...
    $('.Assign').click(function () {
        ...
        var pageup = layer.open({
            ...
            shade: 0.8,
            area: ['80%', '80%'],
            content: '<?=\yii\helpers\Url::to(['/examine/examine/audit-assign-list'])?>&id='+id
        });
    })
    //取消指派
    $('.qxzp').click(function(){
