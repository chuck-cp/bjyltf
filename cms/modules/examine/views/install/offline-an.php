...
//        'action' => ['index'],
    ...
    <div class="row">
        ...
        <div class="col-xs-2 form-group">
            <?=$form->field($searchModel,'status')->dropDownList(['3'=>'安装待审核','4'=>'审核未通过'],['class'=>'form-control fm','prompt'=>'全部'])->label('申请状态');?>
        </div>
        <div class="col-xs-2 form-group">
            ...
            [
                ...
                'buttons' => [
                    'view' => function($url,$searchModel){
                        return Html::a('查看详情',['/examine/install/view','id'=>$searchModel->id, 'apply_name'=>$searchModel->apply['apply_name']]);
                    }
                ],
            ],
        ]
