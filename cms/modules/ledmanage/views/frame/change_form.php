...
<!--            --><?//= $form->field($model, 'nfc')->radioList(['1'=>'有','2'=>'无'],['class' => 'form-control fm','value'=>'1'])->label(false) ?>
<!--        </div>-->
<!--        <div class="col-md-3">-->
...
<!--        </div>-->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?= $form->field($model, 'remark')->textarea(['placeholder'=>'备注信息','class'=>'form-control ','rows' => 4,'cols' => 190])->label(false); ?>
        </div>
    </div>
    <hr>
    <h4>设备编号：</h4>
        ...
        $(".sub").click(function () {
            ...
            $(".mleft").each(function () {
                ...
                if(__this){
                    ...
                    var data = new Object();
                    data.number = __this;
                    data.kuid = $('input[name="SystemDeviceFrame[office_id]"]').val();
