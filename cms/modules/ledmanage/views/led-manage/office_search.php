...
//        'action' => ['index'],
    ...
    <table class="grid table table-striped table-bordered search">
        <tr>
            ...
            <td>
                <p>GPS</p>
                <?=$form->field($model,'gps')->dropDownList(['0'=>'无','1'=>'有'],['prompt' => '全部','class' => 'form-control'])->label(false); ?>
               <!-- --><?/*=$form->field($model,'device_number')->textInput(['class' => 'form-control'])->label(false); */?>
            </td>
            <td>
                <p>是否出库</p>
            ...
            <td>
                ...
                <p>入库仓库</p>
                <?=$form->field($model,'storehouse')->dropDownList(SystemDevice::getNamesByIndex('storehouse','', true,$kuid),['prompt' => '全部','class' => 'form-control'])->label(false); ?>
               <!-- --><?/*=$form->field($model,'device_number')->textInput(['class' => 'form-control'])->label(false); */?>
            </td>
            <td>
                <p>设备规格</p>
