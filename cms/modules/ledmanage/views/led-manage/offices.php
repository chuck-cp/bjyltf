...
<!--                <td><input class="aa" type="checkbox" name="selection[]" value="--><?//echo $v['id']?><!--"></td>-->
                ...
                <!--<td><?/*echo array_key_exists($v['storehouse'],$asArr['config']['storehouse']) ? $asArr['config']['storehouse'][$v['storehouse']] : '未设置';*/?></td>-->
    ...
    $(function () {
        ...
        $('.out').bind('click', function () {
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['80%', '80%'],
                content: '<?=\yii\helpers\Url::to(['/ledmanage/led-manage/single'])?>&deviceid='+id+'&kuid='+kuid
            });
        })
        ...
        $('.batch').bind('click', function () {
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['80%', '90%'],
                content: '<?=\yii\helpers\Url::to(['/ledmanage/led-manage/batchs'])?>&kuid='+kuid
            });
        })
