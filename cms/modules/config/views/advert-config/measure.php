...
<!--    --><?php // echo $this->render('_search', ['model' => $searchModel]); ?>
    ...
    <p>
        <?= Html::a('添加', 'javascript:void(0);', ['class' => 'btn btn-success','type'=>4]) ?>
    </p>
...
//            'shape',
            ...
            [
                ...
                'header' => '操作',
                'template' => '{upmeasure}  {delmeasure}',
                'buttons' => [
                    'upmeasure' => function($url,$model){
//                        return html::a('编辑','javascript:void(0);',['class'=>'upmeasure','id'=>$model->id]);
                    },
                    'delmeasure' => function($url,$model){
                        return html::a('删除','javascript:void(0);',['class'=>'delmeasure','id'=>$model->id,'action'=>$action = Yii::$app->controller->action->id]);
                    }
                ],
            ],
        ],
