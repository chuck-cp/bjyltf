        ...
        <tr>
            ...
            <td colspan="3">
                <?foreach ($offices as $v):?>
                    <input type="checkbox" name="User[office_name][]"  <?if(in_array($v['id'],explode(',',$model->office_auth))):?>checked="checked"<?endif;?> value="<?echo $v['id']?>"><?echo $v['office_name']?>&nbsp;&nbsp;&nbsp;&nbsp;
                <?endforeach;?>
            </td>
        </tr>
