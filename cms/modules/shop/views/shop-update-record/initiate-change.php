...
<!--    <h3 style="border-top: none;font-size: 18px; background-color:#486d93; color: #fff;"><b>商家信息：</b></h3>-->
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td><?=Html::button('选择商家',['class'=>'btn btn-primary choose'])?></td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
...
<!--    <table cclass="table table-hover" style="width: 100%;">-->
        ...
        <tr>
            ...
            <td>
                <input type="text" name="update_apply_name" class="form-control fm" value="<?=Html::encode($model->update_apply_name)?>">
            </td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td><input type="text" id="btn_getNum" name="update_apply_mobile" class="form-control fm" value="<?=Html::encode($model->update_apply_mobile)?>"></td>
            <td><?=Html::Button('验证注册状态',['class'=>'btn btn-primary checkbut'])?></td>
        ...
        <tr>
            ...
            <td><input type="text" name="update_identity_card_num" class="form-control fm" value="<?=Html::encode($model->update_identity_card_num)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td style="text-align: center">
                <?= $form->field($model,'update_identity_card_front')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_identity_card_back')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td><p>联系人：</p></td>
            <td><input type="text" name="update_contacts_name" class="form-control fm" value="<?=Html::encode($model->update_contacts_name)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td><p>联系人电话：</p></td>
            <td><input type="text" name="update_contacts_mobile" class="form-control fm" value="<?=Html::encode($model->update_contacts_mobile)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td style="text-align: center">
                <?= $form->field($model,'update_agent_identity_card_front')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_agent_identity_card_back')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
        ...
        <tr>
            <td><p>变更店铺名称：</p></td>
            <td><input type="text" name="update_shop_name" class="form-control fm" value="<?=Html::encode($model->update_shop_name)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td><p>变更公司名称：</p></td>
            <td><input type="text" name="update_company_name" class="form-control fm" value="<?=Html::encode($model->update_company_name)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td><p>统一社会信用码：</p></td>
            <td><input type="text" name="update_registration_mark" class="form-control fm" value="<?=Html::encode($model->update_registration_mark)?>"></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>
                <p>所属省</p>
                <?php  echo $form->field($model, 'province')->dropDownList(\cms\models\SystemAddress::getAreasByPid(101),['prompt'=>'全部','key'=>'province','class'=>'form-control area fm'])->label(false) ?>
            </td>
            <td>
                <p>所属市</p>
                <?php  echo $form->field($model, 'city')->dropDownList(\cms\models\SystemAddress::getAreasByPid($model->province),['prompt'=>'全部','key'=>'city','class'=>'form-control area fm'])->label(false) ?>
            </td>
            <td>
                <p>所属区</p>
                <?php  echo $form->field($model, 'area')->dropDownList(\cms\models\SystemAddress::getAreasByPid($model->city),['prompt'=>'全部','key'=>'area','class'=>'form-control area fm'])->label(false) ?>
            </td>
            <td>
                <p>所属街道</p>
                <?php  echo $form->field($model, 'town')->dropDownList(\cms\models\SystemAddress::getAreasByPid($model->area),['prompt'=>'全部','key'=>'town','class'=>'form-control fm'])->label(false) ?>
            </td>
            <td>
                <p>详细地址：</p>
                <input type="text" name="update_address" class="form-control fm" value="<?=Html::encode($model->update_address)?>">
            </td>
            <td></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align: center">
                <?= $form->field($model,'update_business_licence')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_shop_image')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_panorama_image')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td style="text-align: center;">
                <?= $form->field($model,'update_authorize_image')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_authorize_image2')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_authorize_image3')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_authorize_image4')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
                <?= $form->field($model,'update_authorize_image5')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center;">
            </td>
        </tr>
        ...
        <tr>
            <td style="text-align: center">
                <?= $form->field($model,'update_other_image')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_other_image2')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_other_image3')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_other_image4')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
                <?= $form->field($model,'update_other_image5')->widget('yidashi\uploader\SingleWidget')->label(false); ?>
            </td>
            <td style="text-align: center">
            </td>
        </tr>
