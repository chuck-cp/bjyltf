            ...
            [
                ...
                'buttons' => [
                    'view' => function($url,$searchModel){
                        if($searchModel->examine_status == 2) {
                            return Html::a('查看详情', ['/shop/shop-update-record/initiate-change', 'id' => $searchModel->id]);
                        }else{
                            return Html::a('查看详情', ['/shop/shop-update-record/initiate-change-view', 'id' => $searchModel->id]);
                        }
                    },
                ],
            ],
