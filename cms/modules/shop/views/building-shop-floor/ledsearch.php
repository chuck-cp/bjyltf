    ...
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                ...
                <td>
                    <p>申请状态</p>
                    <?=$form->field($searchModel,'led_examine_status')->dropDownList(['0'=>'申请待审核','1'=>'申请未通过','2'=>'待安装','3'=>'安装待审核','4'=>'安装未通过','5'=>'安装完成','6'=>'已关闭'],['class'=>'form-control fm','prompt'=>'全部'])->label(false);?>
                </td>
                <td>
                    <p>合同状态</p>
                ...
                <td colspan="">
                    <p>审核通过时间</p>
                    <?= $form->field($searchModel, 'led_examine_at')->textInput(['placeholder'=>'开始时间','class'=>'form-control fm datepicker'])->label(false);?>
                </td>
                <td colspan="">
                    <p>.</p>
                    <?= $form->field($searchModel, 'led_examine_end')->textInput(['placeholder'=>'结束时间','class'=>'form-control fm datepicker'])->label(false); ?>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="">
                    <p>楼宇安装完成时间</p>
                    <?= $form->field($searchModel, 'led_install_finish_at')->textInput(['placeholder'=>'开始时间','class'=>'form-control fm datepicker'])->label(false);?>
                </td>
                <td colspan="">
                    <p>.</p>
                    <?= $form->field($searchModel, 'led_install_finish_end')->textInput(['placeholder'=>'结束时间','class'=>'form-control fm datepicker'])->label(false); ?>
                </td>
                <td colspan="">
                    <p>合同审核通过时间</p>
