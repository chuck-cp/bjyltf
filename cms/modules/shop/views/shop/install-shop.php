...
<div class="shop_search">
    ...
    $form = ActiveForm::begin([
        'action' => ['install-shop','create_at_start'=>$searchModel->create_at_start,'create_at_end'=>$searchModel->create_at_end,'areas'=>$searchModel->areas],
        'method' => 'get',
    ]);
    ?>
    <div class="row">
        <table class="grid table table-striped table-bordered search">
            <tr>
                ...
                <td>
                    <p>安装人员</p>
                    <?=$form->field($searchModel,'install_member_name')->textInput(['placeholder'=>'安装人员','class'=>'form-control fm'])->label(false);?>
                </td>
                <td>
                    <p>店铺位置</p>
