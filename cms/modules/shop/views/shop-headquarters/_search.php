...
<div class="shop-headquarters-search">
    ...
    <div class="row">
        <div class="col-xs-2 form-group" style="padding-right: 0px;">
            <?=$form->field($model,'id')->textInput(['class'=>'form-control fm'])->label('总部编号');?>
        </div>
        ...
        <div class="col-xs-2 form-group">
            <?=$form->field($model,'agreed')->dropDownList(['1'=>'开启','2'=>'关闭'],['class'=>'form-control fm','prompt'=>'全部'])->label('店铺广告');?>
        </div>
        <div class="col-xs-2 form-group">
