...
/**
 * This is the model class for table "yl_building_shop_contract".
 *
 * @property string $id
 * @property string $shop_id 店铺ID
 * @property int $shop_type 店铺类型(1、写字楼 2、公园)
 ...
 */
class BuildingShopContract extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'yl_building_shop_contract';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['examine_at', 'create_at'], 'safe'],
            [['contract_number'], 'string', 'max' => 50],
            [['cabinet_number', 'receiver_name'], 'string', 'max' => 10],
            [['description'], 'string', 'max' => 100],
            [['shop_id', 'shop_type'], 'unique', 'targetAttribute' => ['shop_id', 'shop_type']],
        ];
    }
